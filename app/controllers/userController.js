...
exports.createUser = function(req,res){
  ...
  if(userData.username == "" || userData.password == "" ){
    res.render('/user/createUser',{pageTitle: "Create user", "newUser": userData, 'message': 'Please enter all the required data!!!'});
  }
  ...
  if(userId <= userData.userRoleId){
    ...
    User.create(userData).then(function(newUser,created){
      if(!newUser){
        res.render('/user/createUser',{pageTitle: "Create user", "newUser": userData, 'message': "You couldn't be created"});
      }
      if (newUser){
